...
//	}
//
//	NerfShotApp nershot_app;
//
//	for (auto file : get(files)) {
//		nershot_app.load_file(file);
//	}
//
//	if (scene_flag) {
//		nershot_app.load_training_data(get(scene_flag));
//	}
//
//	if (snapshot_flag) {
//		nershot_app.load_snapshot(get(snapshot_flag));
//	} else if (network_config_flag) {
//		nershot_app.reload_network_from_file(get(network_config_flag));
//	}
//
//	nershot_app.m_train = !no_train_flag;
//
//#ifdef NGP_GUI
...
//
//	if (gui) {
//		nershot_app.init_window(width_flag ? get(width_flag) : 1920, height_flag ? get(height_flag) : 1080);
//	}
//
//	if (vr_flag) {
//		nershot_app.init_vr();
...
//	while (nershot_app.frame()) {
//		if (!gui) {
//			tlog::info() << "iteration=" << nershot_app.m_training_step << " loss=" << nershot_app.m_loss_scalar.val();
//		}
//	}
//
//	return 0;
